    ...
    <div>
        <form id="pedido-form" @submit="criarPedido($event)">
            ...
            <div class="inputs" id="form-pedido">
                ...
                <input type="text" v-model="nomeCliente" id="nome-cliente" name="nome-cliente"
            ...
            <div class="inputs">
                ...
                <div class="checkbox-container" id="checkbox-container" v-for="bebida in listaBebidas" :key="bebida.id">
